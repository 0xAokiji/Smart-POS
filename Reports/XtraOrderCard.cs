...
{
    public partial class XtraOrderCard : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraOrderCard()
        {
            InitializeComponent();
            xrLabel8.ExpressionBindings.Add(new ExpressionBinding("BeforePrint", "Visible", "[Breakable] = True"));
