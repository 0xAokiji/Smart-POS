namespace pos.Model.Stor
{
    partial class frmShowReturns
    {
        ...
        private void InitializeComponent()
        {
            ...
            AddItem.Size = new Size(87, 24);
            AddItem.Text = " العملاء";
            // 
            // فواتيرالعميلToolStripMenuItem
            // 
            فواتيرالعميلToolStripMenuItem.Image = Properties.Resources.add_dark;
            فواتيرالعميلToolStripMenuItem.Name = "فواتيرالعميلToolStripMenuItem";
            فواتيرالعميلToolStripMenuItem.Size = new Size(184, 26);
            فواتيرالعميلToolStripMenuItem.Text = "اضافة مرتجعات";
            فواتيرالعميلToolStripMenuItem.Click += فواتيرالعميلToolStripMenuItem_Click;
            // 
            // فواتيرالعملاءالمحذوفةToolStripMenuItem
            // 
            فواتيرالعملاءالمحذوفةToolStripMenuItem.Image = Properties.Resources.showpass_dark;
            فواتيرالعملاءالمحذوفةToolStripMenuItem.Name = "فواتيرالعملاءالمحذوفةToolStripMenuItem";
            فواتيرالعملاءالمحذوفةToolStripMenuItem.Size = new Size(184, 26);
            فواتيرالعملاءالمحذوفةToolStripMenuItem.Text = "عرض المرتجعات";
            ...
            toolStripProduct.Size = new Size(99, 24);
            toolStripProduct.Text = " الموردين";
            // 
            // عرضالمنتجاتToolStripMenuItem1
            // 
            عرضالمنتجاتToolStripMenuItem1.Image = Properties.Resources.add_dark;
            عرضالمنتجاتToolStripMenuItem1.Name = "عرضالمنتجاتToolStripMenuItem1";
            عرضالمنتجاتToolStripMenuItem1.Size = new Size(184, 26);
            عرضالمنتجاتToolStripMenuItem1.Text = "اضافة مرتجعات";
            عرضالمنتجاتToolStripMenuItem1.Click += عرضالمنتجاتToolStripMenuItem1_Click;
            // 
            // اضافةمنتجبدونفاتورهToolStripMenuItem
            // 
            اضافةمنتجبدونفاتورهToolStripMenuItem.Image = Properties.Resources.showpass_dark;
            اضافةمنتجبدونفاتورهToolStripMenuItem.Name = "اضافةمنتجبدونفاتورهToolStripMenuItem";
            اضافةمنتجبدونفاتورهToolStripMenuItem.Size = new Size(184, 26);
            اضافةمنتجبدونفاتورهToolStripMenuItem.Text = "عرض المرتجعات";
